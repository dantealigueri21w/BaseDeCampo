...
class MotorRepasoTest {
    ...
    fun `un item cuya revision ya llego aparece como pendiente para hoy`() {
        val pendiente = RepasoPendiente("frio_puna", fechaUltimoFallo = 0L, intervaloDias = 1, proximaRevision = 1000L)
    ...
    fun `un item cuya revision es en el futuro no aparece pendiente todavia`() {
        val pendiente = RepasoPendiente("frio_puna", fechaUltimoFallo = 0L, intervaloDias = 1, proximaRevision = 5000L)
